...
var file_user_rpc_user_proto_rawDesc = []byte{
	...
	0x64, 0x32, 0x30, 0x0a, 0x05, 0x75, 0x73, 0x65, 0x72, 0x73, 0x12, 0x27, 0x0a, 0x05, 0x6c, 0x6f,
...
var file_user_rpc_user_proto_depIdxs = []int32{
	1, // 0: user.users.login:input_type -> user.loginRes
	0, // 1: user.users.login:output_type -> user.response
